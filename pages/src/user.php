                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        ?>
                            <!-- </div> -->
                        <a
                            class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="./storeIssue.php"><i
                                class="fas fa-download fa-sm text-white-50"></i>&nbsp;Mobile CARD
                        </a>
                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($rows = mysqli_fetch_array($res_data)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="./../../assets/fn/ictanswered.php?id=<?= $rows['id']?>">
                                                            ...
                                                            <a href="#.php?id=<?= $rows['id'];?>" type="button" data-bs-toggle="modal" data-bs-target="#editmodal">
