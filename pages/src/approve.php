    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    href="admin.php"><img class="border rounded-circle img-profile"
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Store
                                                    Issued of 2017</span></div>
                                    ...
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1">
                                                <span>Purchased Issue Price</span></div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Approve area</h6>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM request WHERE department='core' && approvedby='' ORDER BY requesteddate ASC";
                                        ...
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $rows['amount']; ?></td>
                                                    <td>
                                                        <a href="./pages/authorizeform.php?id=<?=$rows['id'];?>">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Monthly Summary</h6>
