...
$query_table = "SELECT * FROM ictcomment ORDER BY id DESC";
...
$totalRowsStmt = $pdo->query("SELECT COUNT(*) FROM ictcomment");
...
$stmt = $pdo->prepare("SELECT * FROM ictcomment ORDER BY date DESC LIMIT :limit OFFSET :offset");
