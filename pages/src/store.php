            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Store Management</h3>
                        ...
                        <div class="col-lg-7 col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Mobile card on Progress</h6>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title" id="editmodalLabel">Mobile card issued</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="./../../assets/fn/storeissue.php">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="issueddate" type="date" class="form-control" id="issueddate"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="issuedby" type="text" class="form-control" id="issuedby"  
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success">Store issued</button>
                                    </div>
                                </div><br>
