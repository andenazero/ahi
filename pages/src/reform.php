                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Store Issued of 2017</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>156</span></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-cart-arrow-down fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Purchased Issue Price</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-info py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>System Implementation</span></div>
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                    ...
                    <div class="row">
                        <!-- <div class="col-xl-8">
                            <div class="card shadow mb-4">
                                ...
                                <div style="margin: 15px;">
                                    <form method="POST" action="./assets/function/requestins.php">
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-2 col-form-label">Request by</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="items" class="col-sm-2 col-form-label">Item Name</label>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-4">
                                                <input name="requesteddate" type="date" class="form-control" id="items"
                                                    placeholder="Date">
                                            </div>
                                        </div><br>
                        ...
                        <div class="col-lg-5 col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Customer Satisfaction </h6>
                                </div>
                                <div class="card-body">
                                  ...
                                  <?php
                                    ...
                                    $sql = "SELECT * FROM surveillance WHERE status='new'";
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $rows['opt3']; ?></td>
                                                <td><?= $rows['opt4']; ?></td> 
                                                <td><a href="./../../assets/fn/reformstatus.php?id=<?= $rows['id']; ?>">
