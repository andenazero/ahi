        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="dropdown-submenu">
                        <a id="navbarLevel2" class="dropdown-item dropdown-toggle" href="#" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ICT </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarLevel2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="https://www.eservices.gov.et/en" target="_blank">eService</a>
                        </li>
                                        ...
                                        <div>
                                            <div style="max-width: 100%;">
                                                <div style="text-align:center;">
                                                    <h1 style="margin:10px">እንኳን ወደ እንስሳት ጤና ኢንስቲትዩት <br>የውስጥ መገናኛ ዘዴ
                                                        በሰላም
                                                        መጡ!</h1>
                                                </div>
                                                <h4 style="text-align:center; margin:5%">በዚህ መረጃ መስጫ ገጽ፡ ከመረጃ መለዋወጥ ባሻገር
                                                    የተለያዩ አገልግሎት መጠየቂያ
                                                    ፎርሞችን፡ የመንግስትን ዲጂታል አሰራር ለውጥ ተከትሎ በተቋማችን የተተገበሩትን ሲስተም ማስፈንጠሪያዎችና፡
                                                    ግልፅ
                                                    አሰራርን ለማስፈን የሚረዱ የተለያዩ መተዳደሪያ ደንቦችንና ህጎችን ከዲጂታል ላይብረሪ ማግኘት ይችላሉ፡፡
                                                </h4>
                                    ...
                                    <div class="col-md-10 d-md-flex text-center" style="height: 460px">
                                        ...
                                        <div style="max-width: 100%; margin-top: 50px">
                                            ...
                                            <p class="align-justify" style="align-content: justify;">
                                                Day 1: Review of the progress of research activities conducted in 2018
                                                E.C. Thursday, June 04, 2026 [ግንቦት 27/2018ዓ.ም]
                                            </p>
                                            <br>
                                            <a class="btn btn-warning btn-lg" role="button"
                                                href="./assets/img/banner/Day_1_Schedule.pdf" target="_blank">Read
                                                More</a>
                                ...
                                <div class="row gy-4 gy-md-0 justify-content-center align-items-center">
                                    <div class="col-md-10 d-md-flex text-center" style="height: 460px">
                                        <div style="max-width: 100%; margin-top:50px;">
                                            ...
                                            <hr>
                                            <p class="align-justify" style="align-content: justify;">
                                                Day 2: Review of the progress of research activities conducted in 2018
                                                E.C. Thursday, June 04, 2026 [ግንቦት 27/2018ዓ.ም]
                                            </p>
                                            <br>
                                            <a class="btn btn-warning btn-lg" role="button"
